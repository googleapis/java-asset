      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            destination_ =
                input.readMessage(com.google.cloud.asset.v1.GcsDestination.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 18: {
            ...
            if (destinationCase_ == 2) {
              subBuilder = ((com.google.cloud.asset.v1.BigQueryDestination) destination_).toBuilder();
            }
            destination_ =
                input.readMessage(com.google.cloud.asset.v1.BigQueryDestination.parser(), extensionRegistry);
            if (subBuilder != null) {
