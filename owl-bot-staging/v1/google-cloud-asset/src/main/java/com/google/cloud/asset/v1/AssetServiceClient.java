...
public class AssetServiceClient implements BackgroundResource {
   ...
   *       <li> `location:us-west&#42;` to find Cloud resources whose location contains both "us"
   ...
   *       <li> `kmsKey:key` to find Cloud resources encrypted with a customer-managed encryption
   *           key whose name contains the word "key".
   ...
   *           Admin role.
   *       <li> `policy:comp&#42;` to find IAM policy bindings that contain "comp" as a prefix of
   *           any word in the binding.
