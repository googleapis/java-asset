  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "set/v1p4beta1/assets.proto\032\032google/iam/v1/policy.proto\032#google/longrunning/operations.proto\032\036google/protobuf/duration.proto\032\027google/api/client.proto\"\376\003\n"
          + "\026IamPolicyAnalysisQuery\022\023\n"
          + "\006parent\030\001 \001(\tB\003\340A\002\022e\n"
          + "\021resource_selector\030\002"
          + " \001(\0132E.google.cloud.asset.v1p4beta1.IamPolicyAnalysisQuery.ResourceSelectorB\003\340A\001\022e\n"
          + "\021identity_selector\030\003"
          + " \001(\0132E.google.cloud.asset.v1p4beta1.IamPolicyAnalysisQuery.IdentitySelectorB\003\340A\001\022a\n"
          + "\017access_selector\030\004"
          + " \001(\0132C.google.cloud.asset.v1p4beta1.IamPolicyAnalysisQuery.AccessSelectorB\003\340A\001\0323\n"
          ...
          + "\013permissions\030\002 \003(\tB\003\340A\001\"\327\003\n"
          + "\027AnalyzeIamPolicyRequest\022Q\n"
          + "\016analysis_query\030\001"
          + " \001(\01324.google.cloud.asset.v1p4beta1.IamPolicyAnalysisQueryB\003\340A\002\022S\n"
          + "\007options\030\002"
          + " \001(\0132=.google.cloud.asset.v1p4beta1.AnalyzeIamPolicyRequest.OptionsB\003\340A\001\032\223\002\n"
          + "\007Options\022\032\n\r"
          ...
          + "%analyze_service_account_impersonation\030\006 \001(\010B\003\340A\001\0229\n"
          + "\021execution_timeout\030\007"
          + " \001(\0132\031.google.protobuf.DurationB\003\340A\001\"\274\004\n"
          + "\030AnalyzeIamPolicyResponse\022_\n\r"
          + "main_analysis\030\001"
          + " \001(\0132H.google.cloud.asset.v1p4beta1.AnalyzeIamPolicyResponse.IamPolicyAnalysis\022x\n"
          + "&service_account_impersonation_analysis\030\002"
          + " \003(\0132H.google.cloud.asset.v1p4beta1.AnalyzeIamPolicyResponse.IamPolicyAnalysis\022\026\n"
          + "\016fully_explored\030\003 \001(\010\022`\n"
          + "\023non_critical_errors\030\004"
          + " \003(\0132C.google.cloud.asset.v1p4beta1.IamPolicyAnalysisResult.AnalysisState\032\312\001\n"
          + "\021IamPolicyAnalysis\022L\n"
          + "\016analysis_query\030\001"
          + " \001(\01324.google.cloud.asset.v1p4beta1.IamPolicyAnalysisQuery\022O\n"
          + "\020analysis_results\030\002"
          + " \003(\01325.google.cloud.asset.v1p4beta1.IamPolicyAnalysisResult\022\026\n"
          + "\016fully_explored\030\003 \001(\010\"\271\001\n"
          + "\035IamPolicyAnalysisOutputConfig\022e\n"
          + "\017gcs_destination\030\001"
          + " \001(\0132J.google.cloud.asset.v1p4beta1.IamPolicyAnalysisOutputConfig.GcsDestinationH\000\032\"\n"
          + "\016GcsDestination\022\020\n"
          + "\003uri\030\001 \001(\tB\003\340A\002B\r\n"
          + "\013destination\"\203\004\n"
          + "\036ExportIamPolicyAnalysisRequest\022Q\n"
          + "\016analysis_query\030\001"
          + " \001(\01324.google.cloud.asset.v1p4beta1.IamPolicyAnalysisQueryB\003\340A\002\022Z\n"
          + "\007options\030\002"
          + " \001(\0132D.google.cloud.asset.v1p4beta1.ExportIamPolicyAnalysisRequest.OptionsB\003\340A\001\022W\n\r"
          + "output_config\030\003"
          + " \001(\0132;.google.cloud.asset.v1p4beta1.IamPolicyAnalysisOutputConfigB\003\340A\002\032\330\001\n"
          + "\007Options\022\032\n\r"
          + "expand_groups\030\001 \001(\010B\003\340A\001\022\031\n"
          + "\014expand_roles\030\002 \001(\010B\003\340A\001\022\035\n"
          + "\020expand_resources\030\003 \001(\010B\003\340A\001\022\"\n"
          + "\025output_resource_edges\030\004 \001(\010B\003\340A\001\022\037\n"
          + "\022output_group_edges\030\005 \001(\010B\003\340A\001\0222\n"
          + "%analyze_service_account_impersonation\030\006 \001(\010B\003\340A\001\"u\n"
          + "\037ExportIamPolicyAnalysisResponse\022R\n\r"
          + "output_config\030\001"
          + " \001(\0132;.google.cloud.asset.v1p4beta1.IamPolicyAnalysisOutputConfig2\345\004\n"
          + "\014AssetService\022\302\001\n"
          + "\020AnalyzeIamPolicy\0225.google.cloud.asset.v1p4beta1.AnalyzeIamPolicyRequest\0326.google.cloud.asset.v1p4beta1.AnalyzeIamPolicyResponse\"?\202\323\344\223\0029\0227/v1p4beta1/{analysis_query.parent=*/*}:analyzeIamPolicy\022\300\002\n"
          + "\027ExportIamPolicyAnalysis\022<.google.cloud.asset.v"
          + "1p4beta1.ExportIamPolicyAnalysisRequest\032\035.google.longrunning.Operation\"\307\001\202\323\344\223\002C\">/v1p4beta1/{analysis_query.parent=*/*}:exportIamPolicyAnalysis:\001*\312A{\n"
          + "<google.cloud.asset.v1p4beta1.ExportIamPolicyAnaly"
          + "sisResponse\022;google.cloud.asset.v1p4beta1.ExportIamPolicyAnalysisRequest\032M\312A\031cloudasset.googleapis.com\322A.https://www.googleapis.com/auth/cloud-platformB\270\001\n"
          + " com.google.cloud.asset.v1p4beta1B\021AssetServi"
          + "ceProtoP\001ZAgoogle.golang.org/genproto/go"
          + "ogleapis/cloud/asset/v1p4beta1;asset\252\002\034G"
          + "oogle.Cloud.Asset.V1P4Beta1\312\002\034Google\\Cloud\\Asset\\V1p4beta1b\006proto3"
    };
    descriptor =
