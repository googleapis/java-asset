  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "oogle/identity/accesscontextmanager/v1/access_level.proto\032;google/identity/acces"
          + "scontextmanager/v1/access_policy.proto\032(google/cloud/osconfig/v1/inventory.proto"
          ...
          + "gle/rpc/code.proto\032\034google/api/annotations.proto\"\365\002\n\r"
          + "TemporalAsset\0221\n"
          ...
          + " \001(\01624.google.cloud.asset.v1.TemporalAsset.PriorAssetState\0221\n"
          + "\013prior_asset\030\005 \001(\0132\034.google.cloud.asset.v1.Asset\"o\n"
          + "\017PriorAssetState\022!\n"
          + "\035PRIOR_ASSET_STATE_UNSPECIFIED\020\000\022\013\n"
          ...
          + "\010end_time\030\002 \001(\0132\032.google.protobuf.Timestamp\"\263\005\n"
          + "\005Asset\022/\n"
          ...
          + "access_policy\030\007 \001(\01325."
          + "google.identity.accesscontextmanager.v1.AccessPolicyH\000\022L\n"
          + "\014access_level\030\010 \001(\01324.g"
          + "oogle.identity.accesscontextmanager.v1.AccessLevelH\000\022V\n"
          + "\021service_perimeter\030\t \001(\0132"
          + "9.google.identity.accesscontextmanager.v1.ServicePerimeterH\000\0229\n"
          + "\014os_inventory\030\014 \001(\0132#.google.cloud.osconfig.v1.Inventory\022<\n"
          + "\016related_assets\030\r"
          + " \001(\0132$.google.cloud.asset.v1.RelatedAssets\022\021\n"
          + "\tancestors\030\n"
          + " \003(\t:\'\352A$\n"
          ...
          + "\010location\030\010 \001(\t\"\224\001\n\r"
          + "RelatedAssets\022N\n"
          + "\027relationship_attributes\030\001"
          + " \001(\0132-.google.cloud.asset.v1.RelationshipAttributes\0223\n"
          ...
          + "\006labels\030\007"
          + " \003(\01327.google.cloud.asset.v1.ResourceSearchResult.LabelsEntry\022\024\n"
          ...
          + "\005state\030\r"
          + " \001(\t\0226\n"
          + "\025additional_attributes\030\t \001(\0132\027.google.protobuf.Struct\022!\n"
          + "\031parent_full_resource_name\030\023 \001(\t\022E\n"
          + "\023versioned_resources\030\020"
          + " \003(\0132(.google.cloud.asset.v1.VersionedResource\022C\n"
          + "\022attached_resources\030\024"
          + " \003(\0132\'.google.cloud.asset.v1.AttachedResource\022U\n\r"
          + "relationships\030\025 \003(\0132>."
          + "google.cloud.asset.v1.ResourceSearchResult.RelationshipsEntry\022\031\n"
          ...
          + " \003(\0132(.google.cloud.asset.v1.VersionedResource\"U\n"
          + "\020RelatedResources\022A\n"
          + "\021related_resources\030\001 \003(\0132&.google.cloud.asset.v1.RelatedResource\"A\n"
          ...
          + "oogle.cloud.asset.v1.IamPolicySearchResult.Explanation\032\241\002\n"
          + "\013Explanation\022m\n"
          + "\023matched_permissions\030\001 \003(\0132P.google.cloud.asset"
          + ".v1.IamPolicySearchResult.Explanation.MatchedPermissionsEntry\032\"\n"
          ...
          + "e.cloud.asset.v1.IamPolicySearchResult.Explanation.Permissions:\0028\001\"G\n"
          ...
          + "loud.asset.v1.ConditionEvaluation.EvaluationValue\"Y\n"
          ...
          + "2@.google.cloud.asset.v1.IamPolicyAnalysisResult.AccessControlList\022R\n\r"
          + "identity_list\030\004"
          + " \001(\0132;.google.cloud.asset.v1.IamPolicyAnalysisResult.IdentityList\022\026\n"
          + "\016fully_explored\030\005 \001(\010\032m\n"
          + "\010Resource\022\032\n"
          + "\022full_resource_name\030\001 \001(\t\022E\n"
          + "\016analysis_state\030\002 \001(\0132-"
          + ".google.cloud.asset.v1.IamPolicyAnalysisState\032\205\001\n"
          + "\006Access\022\016\n"
          + "\004role\030\001 \001(\tH\000\022\024\n\n"
          + "permission\030\002 \001(\tH\000\022E\n"
          + "\016analysis_state\030\003 \001(\0132-"
          + ".google.cloud.asset.v1.IamPolicyAnalysisStateB\016\n"
          ...
          + "\tresources\030\001"
          + " \003(\01327.google.cloud.asset.v1.IamPolicyAnalysisResult.Resource\022G\n"
          + "\010accesses\030\002"
          + " \003(\01325.google.cloud.asset.v1.IamPolicyAnalysisResult.Access\022K\n"
          + "\016resource_edges\030\003 "
          + "\003(\01323.google.cloud.asset.v1.IamPolicyAnalysisResult.Edge\022H\n"
          + "\024condition_evaluation\030\004"
          + " \001(\0132*.google.cloud.asset.v1.ConditionEvaluation\032\245\001\n"
          + "\014IdentityList\022K\n\n"
          + "identities\030\001"
          + " \003(\01327.google.cloud.asset.v1.IamPolicyAnalysisResult.Identity\022H\n"
          + "\013group_edges\030\002"
          + " \003(\01323.google.cloud.asset.v1.IamPolicyAnalysisResult.EdgeB\230\001\n"
          + "\031com.google.cloud.asset.v1B\n"
          + "AssetProtoP\001Z:google.golang.org/genproto/googleapis/cloud/asset/v1;ass"
